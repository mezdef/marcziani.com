...
module Jekyll
  ...
  class GeneratePhotosets < Generator
    ...
    def generate_photo_data(photoset, site)
      ...
      flickr.access_secret = site.config['flickr']['auth_token_secret']
			...
			photos.photo.each_index do | i |
				...
				aperture = String.new
				focalLength = String.new
				shutterSpeed = String.new
				iso = String.new
        creationDate = String.new
        ...
        exif.exif.each do | e |
            ...
            creationDate = e.raw
				...
				photo = FlickrPhoto.new(title, urlFull, urlThumb, thumbType, description, aperture, focalLength, shutterSpeed, iso, creationDate)
	...
	class FlickrPhoto
		...
		attr_accessor :title, :urlFullSize, :urlThumbnail, :thumbType, :description, :aperture, :focalLength, :shutterSpeed, :iso, :creationDate

		def initialize(title, urlFullSize, urlThumbnail, thumbType, description, aperture, focalLength, shutterSpeed, iso, creationDate)
			@title = title
