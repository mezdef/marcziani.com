...
if (
sessionStorage.getItem('ffSerif') &&
sessionStorage.getItem('ffSerifItalic') &&
sessionStorage.getItem('ffSans') &&
sessionStorage.getItem('ffSansItalic')) {
  webfontLoader('serif');
